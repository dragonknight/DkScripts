...
until [ $salir -eq 1 ]
  do
	...
	echo '      4  .- Servidores de Conexión'
	echo '      5  .- Utilidades de Administrativas (Conexiones, redes, monitoreo)'
	echo ''
	echo '-------------------------------------------------------------------------------------'
	echo '      0  .- Salir'
	echo '====================================================================================='
	...
	case $opt in
	  ...
	  3)
		...
		;; 
	  4)
		echo 'Se instalaran los servidores de Interconexión'
		sleep 5
		aptitude update
		aptitude install ssh
		echo 'Se han instalado los servicios.... Enjoy conecting...'
		;;
	  5)
